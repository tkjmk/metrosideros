...
#Version 0.0.2 edited on 31st May 2018 with two changes: adding option to output files in phylip format, the log file is now output optionally. Both can be controlled by new flags in argparse <output_format> and <log_file>, respectively.
